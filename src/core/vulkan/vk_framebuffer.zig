...
pub const VulkanFramebuffer = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, logDevice: *const vk.DeviceProxy, render_pass: vk.RenderPass, images_view: []vk.ImageView, extent: vk.Extent2D) !VulkanFramebuffer {
